...
\bibitem [{Note1()}]{Note1}%
  \BibitemOpen
  \bibinfo {note} {\protect \texthl {See Supplemental Material at [URL] for
  derivations of the constraint coefficients, extra details for the example
  systems, results for the speed test against DNEB, and a comparison of the
  discontinuous energy landscape with the standard Lennard-Jones
  cluster}}\BibitemShut {NoStop}%
