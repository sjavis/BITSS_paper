...
In \temp{the} step and slide method, the separation between two images is minimised while their energy is fixed (iteratively increasing the energy up to the transition state).
...
\begin{figure}[tb]
  ...
  \caption{\label{fig:adaptivemesh}
    ...
    (a) Snapshots of the BITSS method for the buckling of a cylinder with a changing mesh.
        The radial displacement \temp{relative to the} unbuckled cylinder is shown, as well as the underlying triangular mesh.
