...
{\Cref{fig:speedtest}} shows the comparison between BITSS, DNEB and the string method.
...
In \cref{fig:speedtest}, for each system, BITSS quickly converges to the transition state.
