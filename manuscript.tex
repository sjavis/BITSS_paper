...
This prevents the constraints from washing out the underlying potential or causing large jumps that make a state pass over the dividing ridge.
...
In the event that there are intermediate stable states, then there will be a chain of multiple transition states between the two minima.
In this case, the equal-energy constraint does not restrict the states from passing over the lower energy transition states, and BITSS will converge to the transition state with the highest energy.
