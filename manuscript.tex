...
This is tested here by measuring the speed of convergence to the transition state for BITSS in comparison with the string method \cite{E2007} and DNEB \cite{Trygubenko2004} for three diverse systems, exhibiting a broad range of energy landscapes.
