...
\bibitem [{\citenamefont {Wales}(2002)}]{Wales2002}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {D.~J.}\ \bibnamefont
  {Wales}},\ }\href {https://doi.org/10.1080/00268970210162691} {\bibfield
  {journal} {\bibinfo  {journal} {Molecular Physics}\ }\textbf {\bibinfo
  {volume} {100}},\ \bibinfo {pages} {3285} (\bibinfo {year}
  {2002})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Passerone}\ and\ \citenamefont
  {Parrinello}(2001)}]{Passerone2001}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {D.}~\bibnamefont
  {Passerone}}\ and\ \bibinfo {author} {\bibfnamefont {M.}~\bibnamefont
  {Parrinello}},\ }\href {https://doi.org/10.1103/PhysRevLett.87.108302}
  {\bibfield  {journal} {\bibinfo  {journal} {Physical Review Letters}\
  }\textbf {\bibinfo {volume} {87}},\ \bibinfo {pages} {108302} (\bibinfo
  {year} {2001})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Virot}\ \emph {et~al.}(2017)\citenamefont {Virot},
  \citenamefont {Kreilos}, \citenamefont {Schneider},\ and\ \citenamefont
  {Rubinstein}}]{Virot2017}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {E.}~\bibnamefont
  {Virot}}, \bibinfo {author} {\bibfnamefont {T.}~\bibnamefont {Kreilos}},
  \bibinfo {author} {\bibfnamefont {T.~M.}\ \bibnamefont {Schneider}},\ and\
  \bibinfo {author} {\bibfnamefont {S.~M.}\ \bibnamefont {Rubinstein}},\ }\href
  {https://doi.org/10.1103/PhysRevLett.119.224101} {\bibfield  {journal}
  {\bibinfo  {journal} {Physical Review Letters}\ }\textbf {\bibinfo {volume}
  {119}},\ \bibinfo {pages} {224101} (\bibinfo {year} {2017})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Kusumaatmaja}\ \emph {et~al.}(2006)\citenamefont
  {Kusumaatmaja}, \citenamefont {L{\'{e}}opold{\`{e}}s}, \citenamefont
  {Dupuis},\ and\ \citenamefont {Yeomans}}]{Kusumaatmaja2006}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {H.}~\bibnamefont
  {Kusumaatmaja}}, \bibinfo {author} {\bibfnamefont {J.}~\bibnamefont
  {L{\'{e}}opold{\`{e}}s}}, \bibinfo {author} {\bibfnamefont {A.}~\bibnamefont
  {Dupuis}},\ and\ \bibinfo {author} {\bibfnamefont {J.~M.}\ \bibnamefont
  {Yeomans}},\ }\href {https://doi.org/10.1209/epl/i2005-10452-0} {\bibfield
  {journal} {\bibinfo  {journal} {Europhysics Letters}\ }\textbf {\bibinfo
  {volume} {73}},\ \bibinfo {pages} {740} (\bibinfo {year} {2006})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Brown}\ and\ \citenamefont
  {Bhushan}(2016)}]{Brown2016}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {P.~S.}\ \bibnamefont
  {Brown}}\ and\ \bibinfo {author} {\bibfnamefont {B.}~\bibnamefont
  {Bhushan}},\ }\href {https://doi.org/10.1098/rsta.2016.0135} {\bibfield
  {journal} {\bibinfo  {journal} {Philosophical Transactions of the Royal
