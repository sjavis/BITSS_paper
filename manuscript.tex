...
\begin{table*}[tb]
  ...
  \begin{tabular}{c cc cccc cccc}
    \tworow{System} & \tworow{BITSS} &
      ...
      \multicolumn{4}{c}{DNEB-HEVF} & \multicolumn{4}{c}{CINEB} \\
  ...
  \caption{\label{tab:speed}
    ...
    The climbing-image nudged-elastic-band (CINEB) and DNEB with hybrid eigenvector-following (HEVF) methods have been run for different numbers of images.
