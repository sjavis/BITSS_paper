...
\topic To further increase the speed of the method we can use adaptive remeshing and coarse-graining.

\topic Firstly, we demonstrate in \cref{fig:differentgrids}a that BITSS is able to handle the discretisation changing as the method runs.

\topic For the second test, we investigate how BITSS performs when the two states are using different meshes.
