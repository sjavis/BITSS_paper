...
The initial chain must use an appropriate interpolation, which can sometimes be complicated to produce \cite{Wales2012a}.
In addition to approximating the transition state, these double-ended methods also provide an estimate for the full transition pathway.
...
This has the advantage of not requiring an initial interpolation, unlike other double-ended methods.
Using a range of different applications, we will demonstrate how BITSS addresses each of the above challenges.
